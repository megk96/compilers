...
char * newLabel(){
	...
	strcpy(newLabel,"L");
	snprintf(NUML, 10,"%d",labelnumber);
	strcat(newLabel,NUML);
...
{
       0,    86,    86,   114,   144,   151,   159,   164,   220,   255,
     301,   307,   313,   319,   324,   329,   336,   341,   355,   362,
     374,   380,   393,   434,   476,   482,   513,   518,   561,   602,
     613,   625,   632,   641
};
#endif
...
static const char *const yytname[] =
{
  ...
  "ENDIF", "ENDELSE", "ENDWHILE", "'+'", "'-'", "'*'", "'/'", "'^'", "'%'",
  "'\\n'", "'='", "';'", "'('", "')'", "':'", "$accept", "startSym",
  "program", "construct", "block", "list", "stat", "dec", "bool", "expr",
...
{
      13,   -28,   -28,   -28,   -27,   -24,     4,   -28,    33,    13,
      14,    36,   -28,   -28,     2,   -28,    42,    46,    -6,   -28,
      33,    33,   -28,    34,   -28,    68,    30,   -28,   -28,    -1,
     -28,    33,   -28,    33,    33,   -28,    33,    20,    41,    45,
     -28,   -28,   -28,   -28,   -28,   -28,   -28,   -28,    51,    67,
     -28,    56,    59,    33,    59,   -28,   -28,    64,    61,   -28,
      59,   -28
};
...
{
       0,    32,    33,    31,     0,     0,     0,    19,     0,     0,
       0,     2,     4,     6,     0,    16,     0,     0,    29,    30,
       0,     0,    24,     0,    29,     0,     0,     1,     3,     0,
      17,     0,    21,     0,     0,    20,     0,     0,     0,     0,
      26,    13,    14,    15,    10,    12,    11,    18,     0,    28,
      27,     0,     0,     0,     0,    23,    22,     8,    25,     7,
       0,     9
};
...
{
      23,    20,    -5,    29,    21,     1,     2,     3,    -5,     3,
      -5,     6,    38,    38,    27,    30,     1,     2,     3,     4,
      36,     5,     6,    48,    47,    49,    50,    30,    51,     7,
       8,    29,    -5,     1,     2,     3,     1,     2,     3,     6,
       7,     8,     4,     9,     5,    58,    44,    45,    46,    52,
      18,    53,    25,    33,    28,    34,    22,     7,     8,    18,
      33,     8,    34,    40,    18,    33,     9,    34,    31,    32,
      33,    60,    34,    35,    54,    33,    18,    34,    55,    57,
      33,    59,    34,    56,    41,    42,    43,    61,    34,     9,
      26,    39
};

static const yytype_uint8 yycheck[] =
{
       8,    28,     0,     1,    28,     3,     4,     5,     6,     5,
       8,     9,    20,    21,     0,    14,     3,     4,     5,     6,
      26,     8,     9,    31,    25,    33,    34,    26,    36,    27,
      28,     1,    30,     3,     4,     5,     3,     4,     5,     9,
      27,    28,     6,    30,     8,    53,    16,    17,    18,    29,
       0,    10,     9,    19,    11,    21,     6,    27,    28,     9,
      19,    28,    21,    29,    14,    19,    30,    21,    26,    27,
      19,     7,    21,    27,    29,    19,    26,    21,    27,    52,
      19,    54,    21,    27,    16,    17,    18,    60,    21,    30,
       9,    21
};
...
{
       0,     3,     4,     5,     6,     8,     9,    27,    28,    30,
      32,    33,    34,    35,    36,    37,    38,    40,    41,    42,
      28,    28,    41,    40,    41,    34,    36,     0,    34,     1,
      37,    26,    27,    19,    21,    27,    26,    39,    40,    39,
      29,    16,    17,    18,    16,    17,    18,    25,    40,    40,
      40,    40,    29,    10,    29,    27,    27,    35,    40,    35,
       7,    35
};
